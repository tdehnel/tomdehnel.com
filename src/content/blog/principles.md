---
title: "Principles and concepts list"
date: "2022-06-20"
slug: "principles"
tags: ["Philosophy"]
excerpt: "1.  Writing out my thoughts helps me find errors in my thinking.\n2.  Stating my principles publicly helps me stay accountable."
hero_image: "/images/posts/principles/pascal-debrunner-5Hhc7HrRhpc-unsplash-scaled.jpg"
draft: false
original_url: "https://tomdehnel.com/principles/"
---
...
## You need to be more comfortable with ambiguity

Perhaps the biggest unknown source of trouble is craving certainty. Certainty is a psychological state (a closing of the mind) whereas truth is a property of explanations that accurately describe reality.

When you demand certainty, you inadvertently demand an end to progress. To be certain is to say no further error correction is necessary. If you are certain, you have no reason to look for flaws in your thinking, and therefore no way to improve your ideas.

We tend to fear ambiguity, yet ambiguity is the only place where growth can occur. To thrive, we must learn to trade the comfort of being sure for the discomfort of being curious.

Why the need for certainty causes trouble:

-   **It creates dogmatism:** When people value the feeling of certainty over the search for truth, they begin to treat dissent as a personal attack or a moral failing rather than a tool for error correction.
-   **It leads to the "Noble Lie":** Authorities who feel they _must_ provide certainty to the public will often lie to hide ambiguity, destroying trust when the reality eventually shifts.
-   **It ignores the fallibility of man:** Since we are always fallible, any claim to absolute certainty is a claim to have reached a state where no better explanation could ever exist (which is a logical impossibility in an infinite universe.)

The most productive state of mind is not "I am sure," or "I am very sure" but "This is my best explanation so far, and I am looking for ways to break it." If you want to grow, you must lean into the areas where things don't quite make sense yet. That is where the next breakthrough is hiding.

## Problems are the source of all progress

People create solutions when they have a problem to solve. It's really hard to get people to solve problems they don't care about.

## Being too smart is worse than being too dumb

Thinking you understand things you don't is worse than simply not knowing.

## The most immoral thing is to prevent the growth of knowledge

The only resource which is unlimited in principle is knowledge. The more we discover, the more problems we can solve. Each solution helps us spot new problems, and the cycle continues. This can happen forever.

Yes, I am talking about an infinite knowledge machine.

Since solving problems makes people happier, it's good to keep that process going. Anything which prevents knowledge growth is shutting down a potentially infinite stream of human flourishing. So you want to handle those situations carefully.

Only the most flagrantly evil institutions will explicitly say they want to stop progress. Yet most institutions do exactly that. It always happens when people convince themselves they are the "good guys", and resources (usually other people's time and tax money) should be diverted to their cause. You can spot these people from a mile away, because they hold their core ideas immune from criticism.

Examples of ideas which prevent the growth of knowledge:

1.  “Trust the science,” discourages questioning scientific authority or consensus.
2.  “That’s just your privilege speaking,” dismisses someone’s viewpoint based on identity, not content.
3.  “Educate yourself,” implies ignorance without engaging the argument directly.
4.  “Silence is violence,” labels neutrality, confusion, and ambiguity as immoral, pressuring individuals to conform.
5.  “It’s my lived experience,” frames personal experience as unquestionable truth.
6.  “Believe all victims,” rejects skepticism, potentially ignoring contradictory evidence.
7.  “You’re either with us or against us,” removes nuance, coercing agreement.
8.  “Facts don’t care about your feelings,” dismisses valid emotional considerations in debate.
9.  “Do your own research,” deflects critique by placing responsibility back on the challenger.
10.  “If you disagree, you’re part of the problem,” demonizes dissent, silencing rational objections.

_Note: You might say that this principle is flawed because it's a steadfast moral claim, and I appear to be advocating for yet another institution. But that would be wrong, since the principle also applies to itself. If there is an improved version of this principle available, I will happily switch to it._

## The purpose of "beliefs" are to close the mind

"That singular capacity of mind to multiply relations upon relations in the justification of positions literally unjustifiable, just because they happened to occur in a context considered sacred and therefore to be adhered to literally, at whatever cost, in the service of closing, rather than opening, the mind." - John Deely (Four Ages of Understanding - I haven't read it).

## Lies are wrong, including noble lies

It's wrong to lie, even for a good reason. Lying is wrong because it prevents other people from making good decisions based on reality. It is a form of totalitarianism where the liar attempts to make reality conform to what they wish it were like, rather than what it actually is.

When you convince yourself you are lying for a good purpose, that's called a noble lie. Typically noble lies come from speculating what other people will do if they learn some piece of information, then telling them a lie so they don't do what you think they will do.

But _trying to coerce people by lying to them_ is gaslighting. It's wrong. I don't want to live in a world where noble lies are acceptable because it leads to the breakdown of trust. Even if you lie to someone for a so-called "good reason", every claim you make after that will be subject to suspicion (exponentially so for each additional lie you tell).

## Humans are special because we can explain things

The thing that makes humans special is our ability to form and understand [explanations](https://www.ted.com/talks/the_ted_interview_david_deutsch_on_the_infinite_reach_of_knowledge?language=en).

Humans are the only beings we know of with _universal minds_ which can make up and understand new explanations about what reality is like and why, then test and improve those explanations with logic and/or experiments.
...
Lastly, society functions better when people take responsibility for solving problems. The [murder of Kitty Genovese](https://en.wikipedia.org/wiki/Murder_of_Kitty_Genovese) in 1964 was an example of the problems that can occur when people don't take action because they believe others will.

## Postmodernism is a dead end

The postmodernist ideas that _reality is unknowable_ or _X is a social construct_ (implying that it is invalid) are a bad foundation for life. There are things we do not currently know, and social problems we have yet to solve, but neither of those facts should make you throw up your arms and say "we can't make progress in understanding this thing".
...
A fascinating experiment to try which shows that so-called authorities and institutions often have absolutely no idea what they are talking about:
...
"One of the consequences of such notions as ‘entitlements’ is that people who have contributed nothing to society feel that society owes them something, apparently just for being nice enough to grace us with their presence." —[Thomas Sowell](https://www.deseret.com/2005/10/6/19915755/thomas-sowell-people-with-entitlements-give-nothing-to-society)
...
Free speech is a special type of right because it can create other rights. The reason you currently have any legal rights at all is because [someone spoke up for them before](https://en.wikipedia.org/wiki/Magna_Carta).
...
There is good reason to limit some kinds of speech. [Direct incitement of imminent lawless action](https://www.law.cornell.edu/wex/brandenburg_test), for example. But that by itself is not justification for new limits on speech. Saying "we limit X so it's reasonable to limit Y" does not logically follow.
...
Compromise leads to solutions which nobody wanted in the first place. By compromising, we can never learn whether our ideas are good or bad because we never get to try them out them. When we learn how a compromise is flawed (after it's implemented), no one is responsible for the outcome, everyone blames the other side, and there is huge resistance to try a different solution because "it didn't work last time." But why should the compromise solution work? No one wanted it in the first place.

The other issue with compromise is it can be inherently unfair. Let's say one side wants a smaller administrative state, and the other wants to expand it. A typical compromise might be to expand, but only by a little bit. Over time, this means the side who wanted expansion will always win.

Consensus is wrong for the obvious reason that people can be mistaken. If all your friends jumped off a bridge, would you do it too? This applies to experts too. At one point, nearly every scientist believed gravity was a force emanating from objects. Now no one does. [Here's a long list of other great examples](https://davidfmayer.substack.com/p/the-myth-of-settled-science-a33/).

## Dunning-Kruger isn't just about dumb people

Dunning Kruger is the cognitive bias that causes people to overestimate their abilities and knowledge. Most people think this means "being too dumb to know how dumb you are". But there is a far worse version where smart people start to believe they understand things they do not. And if they think they understand things they start to believe they can control them, or even worse, tell other people how to behave.
